...
**Ecoleta Mobile**, made to see where is the nearest residues collection points in your location. Made up in Next Level Week by Rocketseat
...
- [Expo](https://expo.io) to build the project;
...
**Ecoleta Mobile**, Feito para ver os pontos de coleta de resíduos mais proximos da sua localização. Feito na Next Level Week da Rocketseat.
...
- [Expo](https://expo.io) para a contrução do projeto.
